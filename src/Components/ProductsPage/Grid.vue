        ...
        <div class="view-button">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="MenuLink">
              <a class="dropdown-item" @click="sortI('table')">BÁN CHẠY NHẤT</a>
              <a class="dropdown-item" @click="sortI('lamp')">Sushi & Sashimi Deli</a>
              <a class="dropdown-item" @click="sortI('chair')">Ngao, Sò, Ốc</a>
              <a class="dropdown-item" @click="sortI('sofa')">Cua - Ghẹ</a>
          ...
          <div class="card-selector">
            <div class="card-body p-5">
              <div class="search-title">
                <h4><v-icon> {{listIcon}} </v-icon>DANH MỤC</h4>
                <br>
                <v-card
                  class="categories"
                  max-width="600px"
                >
                  <v-list class="categories">
                    <v-list-item-group>
                      <v-list-item @click="sortI('tom')">
                        Tôm các loại
                      </v-list-item>
                      <v-list-item @click="sortI('ca')">
                        Cá
                      </v-list-item>
                      <v-list-item @click="sortI('oc')">
                        Ốc
                      </v-list-item>
                    </v-list-item-group>
                  </v-list>
...
export default {
  ...
  methods: {
    ...
    valueSlider(value) {
      var x = value[0];
      var y = value[1];
      this.cards = this.it.filter((e)=> x < e.pricePerUnit && e.pricePerUnit < y)
    },
    sortDate() {
...
<style>
.categories {
  background-color: rgb(46, 158, 213) !important;
}
...
.card-selector {
  color: #DCDCDC;
  height: 40rem;
  background: rgb(46, 158, 213) !important;
