  ...
  <div class="container-flex">
    <nav class="navbar navbar-light">
      ...
      <a class="navbar-brand py-0 pl-5">
          <img src="https://image.shutterstock.com/image-vector/tv-vt-logo-vector-initial-600w-1340806751.jpg" width="50" height="50">
      </a>
      <!--Header navigation-->
...
.navbar {
  ...
  background-color: rgb(46, 158, 213);
}
...
.company-name {
  ...
  color: rgb(172, 25, 25) !important;
  text-shadow: -1px 2px 1px #737272;
  border-radius: 10px;
  border-style: solid;
  border-color: #737272;
}
